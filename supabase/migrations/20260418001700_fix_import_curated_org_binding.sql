-- ============================================================
-- 20260418001700_fix_import_curated_org_binding.sql
--
-- import_curated_problem_v1 resolves organizations via ensure_system_org_v1,
-- which returns a composite organizations row. Bind it with `select * from`
-- so Postgres assigns the composite correctly.
-- ============================================================
