-- ============================================================
-- 20260418001900_enforce_iso_access_dates.sql
--
-- Require curated citation access_date values to use ISO YYYY-MM-DD.
-- PostgreSQL will happily coerce other date strings, which is too lax for
-- a reusable import pipeline and makes bad editorial data harder to catch.
-- ============================================================
