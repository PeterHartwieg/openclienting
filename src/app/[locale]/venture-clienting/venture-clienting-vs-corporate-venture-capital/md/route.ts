...
/**
 * Markdown alternative for the "Venture clienting vs CVC" spoke.
 * See `what-is-venture-clienting/md/route.ts` for the shared cache model.
 */
export const revalidate = 3600;

const spoke = getSpokeById("ventureClientingVsCvc");
